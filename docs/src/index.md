...
- String layout: Parsing requires repeated Char comparisons. In UTF8, frequent characters are encoded shorter (8 bit), rare have longer codes.
  ...
  Profiling:
  - `leftof` and `rightof` comsume considerable time.  Could be cached/memoized?
...
```@contents
Pages = [ "lib/public.md", "lib/constructors.md", "lib/parsers.md", "lib/regexp.md", "lib/transformation.md", "lib/internals.md" ]
Depth = 5
```
## [Index](@id main-index)
